...
urlpatterns = [
    ...
    path('case-add-document/<int:case_id>/', views.case_add_document, name='case_add_document'),
    path('case-replace-final-document/<int:case_id>/', views.case_replace_final_document, name='case_replace_final_document'),
